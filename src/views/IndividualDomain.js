...
export default function IndividualDomainPage() {
  return (
    <CippPage title="Email Health Check">
...
export function IndividualDomainCheck({
  ...
  return (
    <CippMasonry>
      <CippMasonryItem size="triple" className="align-items-center">
        <h3>Domain Health Check</h3>
        <p>
          This site is designed to check for common issues with email and security. Enter your
          domain name to see how you&apos;re doing.
        </p>
      </CippMasonryItem>
